...
const Footer = () => {
  return (
    <footer id="contato" className="bg-clinic-dark text-white pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-white hover:text-clinic-accent transition-colors">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-3 mt-1 text-clinic-accent">
